...
import { arrowRight } from "../assets/images/iconstailwind/index";
import { shoes, statistics } from "../constants/index";
import { bigShoe1 } from '../assets/images/index (1)';
...
<div className="relative flex-1 flex justify-center items-center xl:ming-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
  <img 
  src={bigShoeImg}
  alt="Shoe Collection"
  width={610}
